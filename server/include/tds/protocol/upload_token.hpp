...
namespace tds::protocol {
    ...
    public:
        explicit UploadToken(const std::filesystem::path& file, std::filesystem::path temporary_filename_stem,
    ...
    private:
        ...
        const std::filesystem::path m_temporary_filename_stem;
        std::uintmax_t m_size;
        std::uintmax_t m_offset;
    };

    std::shared_ptr<UploadToken> make_upload_token(const std::filesystem::path& file,
                                                   std::filesystem::path temporary_filename_stem,
                                                   std::uintmax_t file_size);
}
