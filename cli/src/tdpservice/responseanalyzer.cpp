...
ConnectionError ResponseAnalyzer::analyseSimpleResponse(string command_name, string &received_response,
                                                        string &response_body, bool isSpecificAnswerExpected) {
    read_buf = received_response;
...
ConnectionError
ResponseAnalyzer::analyseMultilineResponse(string command_name, string &received_response, string &response_body) {
    read_buf = received_response;
    auto iter = read_buf.begin();
    received_response.clear();
    ConnectionError response_code = getResponseHeader(iter, command_name);
...
ConnectionError ResponseAnalyzer::getResponseHeader(string::iterator &iter, string &command_name) {
    ConnectionError response_code = getErrorCode(iter);
